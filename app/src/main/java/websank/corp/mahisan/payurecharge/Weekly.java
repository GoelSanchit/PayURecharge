...
public class Weekly extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getCallDetails();
        String url = "http://sanchitgoel.net78.net/weekly.php";
        ...
        try {
            ...
            sAdap = new SimpleAdapter(Weekly.this, MyArrList, R.layout.feed_item,
...
// TODO Auto-generated catch block
    ...
    private void getCallDetails() {
        ...
        sb.append( "Net Outgoing last Weekday =" + netOutgoing + "sec");
...
//
    ...
    public Date getYesterdayDateString(){
        return new Date(System.currentTimeMillis()-1000L*60L*60L*24L*7L);
    }
